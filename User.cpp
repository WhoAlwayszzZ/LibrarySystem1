...
//重写纯虚函数
void Admin::operate(BookManager& bookmanager, UserManager& usermanager) {
...
void Reader::operate(BookManager& bookmanager, UserManager& usermanager) {
    int choice;
    while (true) {
